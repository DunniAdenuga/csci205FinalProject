...
public class main {
    ...
    public static void main(String[] args){
        ...
        b.clearBoard();
        System.out.println("clearBoard() was called on Board B");
        System.out.println("Board B:Should be valid and incomplete.  isValid()? " + b.isValid() + " isComplete()? " + b.isCompleted());
